...
var ebc_reveal_closer_today_button = $("#reveal_close_today");
ebc_reveal_closer_today_button.length > 0 && ebc_reveal_closer_today_button.on("click", function() {
  localStorage.setItem("ebc_close_today", "true"), localStorage.setItem("ebc_close_today_date", new Date)
});
...
//       "hsFormCallback" === t.data.type && "onFormSubmitted" === t.data.eventName && (void 0, e.slideDown(300), i.slideDown(300))
//     })
//   }
});

$('.category-gallery img').click(function(e) {
...
jQuery(document).ready(function($) {
        ...
        setTimeout(function() {
//           check if checkout if() {}
          var registerContainer = document.querySelector('.woocommerce-checkout .change-title');
          var registerLabelCount = document.querySelector('.woocommerce-checkout .change-title span').innerText;
          
          var firstArr = registerLabelCount.split('(');
          var secondArr = firstArr[1].split(')');
          
          console.log(registerLabelCount);
          if(registerContainer){
            console.log(registerContainer);
              registerContainer.innerText = 'Player ' + ' ' + secondArr[0];
...
//            change css
          ...
          jerseyImg.classList.add('jersey-help--img');
          jerseyImg.classList.add('hide');
          jerseyImg.setAttribute('src','https://elitebasketballcircuit.com/wp-content/uploads/2022/05/sizing.png');
           $('.jersey-help').append(jerseyImg);
  
          $('.jersey-help label').on('click', function() {
            $('.jersey-help--img').toggleClass('hide');
          })
