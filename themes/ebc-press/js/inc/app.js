...
if (ebc_reveal_closer_today_button.length > 0) {
  ebc_reveal_closer_today_button.on('click', function() {
    localStorage.setItem("ebc_close_today", 'true');
    localStorage.setItem("ebc_close_today_date", new Date() );
  });
}
