...
import Block from './blocks/product-category-ebc/block';
 ...
 */
wp.blocks.registerBlockType( 'woocommerce/product-category-ebc', {
	title: __( 'EBC Products by Category', 'woocommerce' ),
	icon: {
		src: 'category',
		foreground: '#96588a',
	},
		...
		from: [
			{
				...
				blocks: without(
					sharedAttributeBlockTypes,
					'woocommerce/product-category-ebc'
				),
				transform: ( attributes ) =>
					wp.blocks.createBlock( 'woocommerce/product-category-ebc', {
						...attributes,
						editMode: false,
					} ),
			},
