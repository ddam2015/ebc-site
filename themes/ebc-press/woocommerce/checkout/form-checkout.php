...
<form id="woocommerce-checkout-form" name="checkout" method="post" class="checkout woocommerce-checkout ebc-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
    ...
    <?php do_action( 'woocommerce_checkout_before_customer_details' ); ?>
		...
		<div class="grid-margin-x" id="customer_details">
   ...
   <p>
     A 2.9% merchant fee is applied to all credit card transactions. We accept <strong>Visa / MasterCard / American Express / Discover</strong>
   </p>
